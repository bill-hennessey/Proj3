...
export function AboutUs() {
  return (
      ...
      <Typography style={styles.mainheader}>
          <h2>About Us</h2>
          <p>Our final group project,  
              <span style={styles.spanStyle}> moovie </span> 
              is a performant and scalable MERNG stack application that showcases what we've learned over the course of Denver University's Full-Stack Certificate Program. We hope you enjoy our application!</p>
          </Typography>

    <Grid container spacing={{p:10, m:10, gap:50}} direction="row" justifyContent="center" alignItems="center">
    {contributorData.map((user) => (
        <Card justifyContent="center" alignItems="center" sx={{ pb: 0, maxWidth: 345 }} >
        <CardMedia
            component="img"
            href={user.gitLink}
            height="194"
        ...
        />
            ...
            <CardContent >
            <Typography card style={styles.header}><h3>{user.name}</h3></Typography>
            ...
            <CardActions disableSpacing style={styles.header}>
                <IconButton aria-label="Github" style={styles.buttons} href={user.gitLink} target="_blank">
                <GitHubIcon />
                </IconButton>
                <IconButton aria-label="LinkedIn" style={styles.buttons} href={user.liLink} target="_blank">
                <LinkedInIcon />
                </IconButton>
            </CardActions>
        </Card>
